...
#include <memory>
#include "../../TankWar/blockKinds/base.h"
...
QT_MOC_LITERAL(5, 13), // "baseDestroyed"
QT_MOC_LITERAL(19, 0) // ""

    },
    "Base\0baseDestroyed\0"
};
...
void Base::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Base::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Base::baseDestroyed)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject Base::staticMetaObject = { {
    ...
    qt_meta_stringdata_Base.offsetsAndSize,
    qt_meta_data_Base,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_Base_t
, QtPrivate::TypeAndForceComplete<Base, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>
