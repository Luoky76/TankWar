...
QT_MOC_LITERAL(9, 12), // "mouseEntered"
QT_MOC_LITERAL(22, 0), // ""
QT_MOC_LITERAL(23, 9) // "mouseLeft"

    },
    "MyButton\0mouseEntered\0\0mouseLeft"
};
...
void MyButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyButton::mouseEntered)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (MyButton::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyButton::mouseLeft)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void MyButton::mouseEntered()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void MyButton::mouseLeft()
{
