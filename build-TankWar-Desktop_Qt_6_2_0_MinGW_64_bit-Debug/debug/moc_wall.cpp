...
#include <memory>
#include "../../TankWar/blockKinds/wall.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_Wall_t, stringdata0) + ofs), len 
...
const QMetaObject Wall::staticMetaObject = { {
    ...
    qt_meta_stringdata_Wall.offsetsAndSize,
    qt_meta_data_Wall,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_Wall_t
